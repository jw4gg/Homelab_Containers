...
_Auto-generated 2026-05-22 15:54 UTC — do not edit manually._
...
| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `homarr` | `homarr` | `ghcr.io/homarr-labs/homarr:v1.61.0` | `7575:7575` | `unless-stopped` |

## homeassistant

| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `homeassistant` | `homeassistant` | `lscr.io/linuxserver/homeassistant:2026.5.3` | `8123:8123` | `unless-stopped` |

## jackett

| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `jacket` | `jackett` | `linuxserver/jackett:0.24.1914` | `9117:9117` | `unless-stopped` |

## jellyfin

| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `jellyfin` | `jellyfin` | `jellyfin/jellyfin:10.11.9` | `8096:8096` `8920:8920` `7359:7359/udp` `1900:1900/udp` | `unless-stopped` |
...
| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `openwebui` | `open-webui` | `ghcr.io/open-webui/open-webui:v0.9.5` | `3030:8080` | `unless-stopped` |
...
| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `pihole` | `pihole` | `pihole/pihole:2026.05.0` | `53:53/tcp` `53:53/udp` `80:80/tcp` | `unless-stopped` |
