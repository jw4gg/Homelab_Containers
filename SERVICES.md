...
_Auto-generated 2026-05-18 15:04 UTC — do not edit manually._
...
| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `homeassistant` | `homeassistant` | `lscr.io/linuxserver/homeassistant:2026.5.2` | `8123:8123` | `unless-stopped` |

## jackett

| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `jacket` | `jackett` | `linuxserver/jackett:0.24.1879` | `9117:9117` | `unless-stopped` |
