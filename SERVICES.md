...
_Auto-generated 2026-06-30 17:08 UTC — do not edit manually._
...
| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `jacket` | `jackett` | `linuxserver/jackett:0.24.2142` | `9117:9117` | `unless-stopped` |
...
| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `openwebui` | `open-webui` | `ghcr.io/open-webui/open-webui:v0.10.1` | `3030:8080` | `unless-stopped` |
