...
_Auto-generated 2026-09-12 15:52 UTC — do not edit manually._
...
| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `homarr` | `homarr` | `ghcr.io/homarr-labs/homarr:v1.77.1` | `7575:7575` | `unless-stopped` |

## homeassistant

| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `homeassistant` | `homeassistant` | `lscr.io/linuxserver/homeassistant:2026.9.2` | `8123:8123` | `unless-stopped` |

## jackett

| Service | Container | Image | Ports | Restart |
|---------|-----------|-------|-------|---------|
| `jacket` | `jackett` | `linuxserver/jackett:0.24.2572` | `9117:9117` | `unless-stopped` |
